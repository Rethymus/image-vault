/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=worker/wrangler.admin.jsonc worker/worker-configuration.d.ts` (hash: d6365c9042f9467e20db801e5612642e)
// Runtime types generated with workerd@1.20260811.1 2026-08-18 nodejs_compat
interface __BaseEnv_Env {
	MEDIA: R2Bucket;
	ASSETS: Fetcher;
	ADMIN_HOST: "YOUR_ADMIN_WORKER.workers.dev";
	UPLOAD_ORIGIN: "https://YOUR_UPLOAD_WORKER.workers.dev";
	PUBLIC_IMAGE_ORIGIN: "https://YOUR_BUCKET_ID.r2.dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_HOST" | "UPLOAD_ORIGIN" | "PUBLIC_IMAGE_ORIGIN" | "MAX_IMAGE_BYTES" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "OWNER_EMAILS">> {}
}
